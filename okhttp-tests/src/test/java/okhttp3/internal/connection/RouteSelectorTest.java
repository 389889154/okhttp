...
public final class RouteSelectorTest {
  ...
  @Test public void singleRoute() throws Exception {
    ...
    RouteSelector routeSelector = new RouteSelector(address, routeDatabase, EventListener.NONE);
  ...
  @Test public void singleRouteReturnsFailedRoute() throws Exception {
    ...
    routeSelector = new RouteSelector(address, routeDatabase, EventListener.NONE);
    assertRoute(routeSelector.next(), address, NO_PROXY, dns.lookup(uriHost, 0), uriPort);
    assertFalse(routeSelector.hasNext());
    try {
      routeSelector.next();
